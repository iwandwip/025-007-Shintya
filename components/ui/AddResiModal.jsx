...
export default function AddResiModal({
  ...
  const handleSubmit = () => {
    if (!noResi.trim()) {
      // Give feedback to user instead of silently returning
      alert("Mohon masukkan nomor resi");
      return;
    }
    console.log("Submitting resi:", { noResi: noResi.trim(), tipePaket });
        ...
        <View style={[styles.modalContainer, { backgroundColor: colors.white }]}>
          ...
          <View style={styles.footer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                console.log("Submit button pressed, noResi:", noResi);
                handleSubmit();
              }}
